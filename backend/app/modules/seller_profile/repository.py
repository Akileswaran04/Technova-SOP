...
class SellerProfileRepository:
    ...
    async def create(self, user_id: UUID, data: dict) -> SellerProfile:
    ...
    async def get_by_id(self, profile_id: UUID) -> Optional[SellerProfile]:
    ...
    async def update(self, profile_id: UUID, data: dict) -> Optional[SellerProfile]:
    ...
    async def update_status(self, profile_id: UUID, status: str) -> Optional[SellerProfile]:
...
class SellerVerificationRepository:
    ...
    async def create(self, seller_id: UUID, data: dict) -> SellerVerification:
    ...
    async def get_by_seller(self, seller_id: UUID) -> list[SellerVerification]:
    ...
    async def update(self, verification_id: UUID, data: dict) -> Optional[SellerVerification]:
