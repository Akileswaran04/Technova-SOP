/**
 * InboxTab — WhatsApp-style messaging interface.
 * Left panel: conversation list. Right panel: chat thread.
 * On mobile: shows list first, tap to open chat, back button to return.
 */
